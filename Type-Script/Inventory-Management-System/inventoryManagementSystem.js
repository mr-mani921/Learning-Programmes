...
(function (ItemCategories) {
    ...
    ItemCategories["GROCERY"] = "GROCERY";
...
class InventoryManager {
    ...
    updateQuantity(itemId, updatedQuantity) {
        let toUpdateItemIndex = this.checkExistence(itemId);
    ...
    filterItemsByCategory(category) {
        ...
        console.log(`${category} items available in our inventory are given below:`);
